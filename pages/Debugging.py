...
estimated_total_revenue = check_estimated_vectorized_final(file)#estimated_sewer+estimated_water+estimated_dcrua#check_estimated_vectorized_final(file).sum()#estimated_water+estimated_sewer+estimated_dcrua
