...
def check_estimated_vectorized_final(df):
    ...
    mask_unknown_both = ~df['Swr Rate'].isin(['IRES','ICOMM','ORES','OCOMM'])
...
estimated_total_revenue = check_estimated_vectorized_final(file).sum()#estimated_sewer+estimated_water+estimated_dcrua#check_estimated_vectorized_final(file).sum()#estimated_water+estimated_sewer+estimated_dcrua
