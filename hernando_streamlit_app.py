...
# --- Distribution of Revenue by Usage Range ---
st.header("Distribution of Estimated Revenue")
st.subheader("IRES Distribution of Revenue by Water Usage (gallons)")
...
ax10.set_title("Revenue Distribution by Usage Range")
st.pyplot(fig4)
...
ax11.set_title("Revenue Distribution by Usage Range")
st.pyplot(fig5)
...
ax12.set_title("Revenue Distribution by Usage Range")
st.pyplot(fig6)
...
ax13.set_title("Revenue Distribution by Usage Range")
st.pyplot(fig7)
...
ax14.set_title("Revenue Distribution by Class + Usage Tier")
st.pyplot(fig8)
...
ax15.set_title("Revenue Distribution by Class + Usage Tier")
st.pyplot(fig9)
